...
@section('content')
	<img src="/img/participe.jpg" style="margin-bottom: -10px"></img>
			...
			<div class="columns is-vcentered content">
				...
				<form class="column is-two-thirds" method="POST" action="/participe">
					...
					<div class="field">
						...
						<div class="control has-icons-left ">
							<input class="input{{ $errors->has('email') ? ' is-danger' : '' }}" type="text" name="email" id="email" placeholder="Digite seu e-mail">
							<span class="icon is-small is-left">
